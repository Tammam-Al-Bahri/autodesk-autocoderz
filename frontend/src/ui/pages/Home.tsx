            ...
            <div className="pt-20 pb-16 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg max-w-2xl mx-auto mb-10">
                        This platform links BIM building models with hotel property management
                        tools. It allows staff to view buildings in 3D and manage maintenance issues
                        in one place.
                    </p>
...
function FeatureCard({ icon, title, desc }: { icon: any; title: string; desc: string }) {
    return (
        <Card className="shadow-sm">
            <CardHeader>
                <div className="w-10 h-10 flex items-center justify-center mb-3">{icon}</div>
