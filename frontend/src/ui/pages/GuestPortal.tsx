        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-2">
              <Button variant="outline" size="sm" onClick={() => requestService("Towels")}>
                Towels
              </Button>
              <Button variant="outline" size="sm" onClick={() => requestService("Cleaning")}>
                Cleaning
              </Button>
              <Button variant="outline" size="sm" onClick={() => requestService("AC")}>
                AC
              </Button>
              <Button variant="outline" size="sm" onClick={() => requestService("Checkout")}>
                Checkout
              </Button>
            </CardContent>
          </Card>
