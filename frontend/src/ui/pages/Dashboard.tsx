...
export default function Dashboard() {
  ...
  const currentHotel =
    hotelList.find((h) => h.id === selectedHotel) || hotelList[0];
    ...
    <div className="min-h-screen bg-slate-50/50 pb-16">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <StatCard
            title="Check Ins"
            value={currentHotel.checkIns}
            icon={<LogIn />}
          />

          <StatCard
            title="Check Outs"
            value={currentHotel.checkOuts}
            icon={<LogOut />}
          />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="lg:col-span-2 bg-slate-900 shadow-xl border-none relative min-h-[450px] group overflow-hidden">
            ...
            <div className="absolute top-4 left-4 flex gap-2 z-10">
              ...
              <Badge variant="outline" className="text-white border-white/20 bg-white/5 backdrop-blur">
                {currentHotel.name}
              </Badge>
          ...
          <Card className="shadow-lg border-none bg-white">
            ...
            <CardContent className="pt-6">
              ...
              <div className="space-y-6">
                ...
                <TicketItem
                  title="Room 302 - Water Leak"
                  time="2 hrs ago"
                />

                <TicketItem
                  title="Room 105 - AC Failure"
                  time="5 hrs ago"
                />

                <TicketItem
                  title="Lobby - Flickering Lights"
                  time="Yesterday"
                />
