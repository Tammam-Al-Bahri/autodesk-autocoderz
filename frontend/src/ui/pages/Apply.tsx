...
export default function Apply() {
    ...
    function withdraw() {
        const confirmBox = window.confirm("Are you sure you want to withdraw this application?");
    ...
    return (
        <div className="max-w-4xl mx-auto mt-6 px-4 pb-16">
            <div className="mb-6">
                ...
                <p className="text-sm text-gray-500">Submit your property details for review.</p>
            </div>
            ...
            {loading ? (
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Upload your 3D model and basic details.</CardDescription>
                    </CardHeader>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="border rounded p-4">
                            <p className="font-semibold">{hotelName || "Your Property"}</p>
                        ...
                        {status === "Pending" && (
                            <Button variant="outline" className="w-full" onClick={withdraw}>
